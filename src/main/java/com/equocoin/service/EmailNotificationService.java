...
public class EmailNotificationService extends HttpServlet {
	...
	public boolean sendEmail(String toEamilId, String subject, String content) {
		...
		if (env.equalsIgnoreCase("dev")) {
			return sendEmailDEV(toEamilId, subject, content);
		} 
	...
	private boolean sendEmailDEV(String toEamilId, String subject, String content) {
		try {
	        ...
	        message += "<b>Thank you for your interest in creating EquaCoin wallet. Your EQC wallet is created successfully & wallet address is mentioned below</b><br>";
	        message += "<font color=red> Wallet Id: "+content +"</font><br>";
	        message += "<b>Below are the steps to purchase EQC:</b><br>";
	        message += "<b>1. You need to transfer your Ether to the registered EQC wallet & then you can buy EquaCoins</b><br>";
	        message += "<b>2. If you have other Cryptos, you need to go to any exchange to convert them into Ether, then buy EquaCoins</b><br>";
	        message += "<b>3. If you don’t own any Cryptos, you need to buy Ether from any exchange, then go to www.equacoin.com  and register</b><br>";
	        message += "<b>4. If you have any problem, please email us to: info@equacoin.com</b><br><br>";
	       	message += "<b>Click here to login to our site : https://equacoin.io</b><br><br>";
	...
	public boolean sendEmailforgot(String toEamilId, String subject, String content) {
		try {
			...
			String message = "<b>Hi,</b><br><br>";
	        message += "<b>Please find your login credentials for www.equacoin.io</b><br>";
